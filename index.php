...
class DropboxUpload
{
    ...
    public function action()
    {
        ...
        add_action('wp_ajax_shot_code_register', [$this, 'add_new_shotcode']);
        add_action('wp_ajax_edit_short_code', [$this, 'edit_short_code']);
        add_action('wp_ajax_delete_short_code', [$this, 'delete_short_code']);
        add_action('wp_ajax_update_short_code_details', [$this, 'update_short_code_details']);
        add_filter('shot-code', [$this, 'shot_code_callback'], 10, 1);
        add_action('init', [$this, 'store_form_data']);
    }
    ...
    public function delete_short_code()
    {
        ...
        $result = $wpdb->delete($table_name, ['id' =>$_POST['short_code_id']]);
        if ($result) {
    ...
    public function add_new_shotcode()
    {
        ...
        $column_values = ['form_id'=>$shortcode_name, 'string'=>$form_array];
    ...
    public function menu()
    {
        ...
        add_submenu_page('create-form', 'Create Form', 'Add Shot Code', 'manage_options', 'create-form', [$this, 'custome_form']);
        add_submenu_page('create-form', 'List Short Code', 'List Short Code', 'manage_options', 'list-shot-code', [$this, 'list_shot_code']);
        add_submenu_page('create-form', 'Short Values', 'View Short Code Data', 'manage_options', 'view_short_code_value', [$this, 'view_short_code_value']);
    ...
    public function store_form_data()
    {
        if (isset($_POST['register'])) {
            ...
            $column_values = ['shortcode_form_data'=>serialize($_POST)];
    ...
    {
        register_activation_hook(__FILE__, [$this, 'activation_table']);
